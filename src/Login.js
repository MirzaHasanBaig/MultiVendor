...
<div className="page-content">
                <div className="container" style={{display:"flex",alignContent:"center",alignItems:"center",flexDirection:"column"}}>
                    <div className="login-popup" style={{width:"100% !important"}}>
                            ...
                            <div className="tab-content">
                                ...
                                <div className="tab-pane" id="sign-up">
                                    ...
                                    <div className="form-checkbox user-checkbox mt-0">
                                        ...
                                        <label for="check-customer" className="check-customer mb-1">I am a customer</label>
                                        <br/>
                                        <input type="checkbox" className="custom-checkbox checkbox-round" id="check-seller" name="check-seller" required=""/>
                                        <label for="check-seller" className="check-seller">I am a vendor</label>
                                    </div>
                                    ...
                                    <div className="form-checkbox d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <label for="remember" className="font-size-md">I agree to the <a href="#" className="text-primary font-size-md">privacy policy</a></label>
                                    </div>
